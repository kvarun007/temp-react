...
export default function RandowColor(){
    const [typeOfColor, setTypeOfColor]= useState("hex");
    const [color,setColor]=useState("#000000")

    function randowColorUtility(length){
    ...
    return (
        <div style={{width:"100vw",height:"100vh",background:color}}>
            ...
            <button onClick={typeOfColor === "hex"? handleCreateRandomHexColor:handleCreateRandomRgbColor}>Generate Randow Color</button>
